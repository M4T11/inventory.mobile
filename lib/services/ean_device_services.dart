...
class EanDeviceService {
  ...
  Future <List<EanDevice>> getAll() async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.105:8000/ean_devices/';
    }
  ...
  Future<int> deleteEanDevice(int id) async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.105:8000/ean_devices/id/' + id.toString();
    }
  ...
  Future<bool> editEanDevice(EanDevice eanDevice) async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.105:8000/ean_devices/id/' + eanDevice.eanDeviceId.toString();
    }
  ...
  Future<bool> addEanDevice(EanDevice eanDevice) async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.105:8000/ean_devices/id';
    }
