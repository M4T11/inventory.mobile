...
class CategoryService {
  ...
  Future <List<Category>> getAll() async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.102:8000/categories/';
  ...
  Future<int> deleteCategory(int id) async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.102:8000/categories/id/' + id.toString();
    }
  ...
  Future<bool> editCategory(Category category) async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.102:8000/categories/id/' + category.categoryId.toString();
    }
