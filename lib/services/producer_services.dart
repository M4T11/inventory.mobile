...
class ProducerService {
  ...
  Future <List<Producer>> getAll() async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.104:8000/producers/';
    }
  ...
  Future<int> deleteProducer(int id) async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.104:8000/producers/id/' + id.toString();
    }
  ...
  Future<bool> editProducer(Producer producer) async {
    ...
    if (local) {
      ...
      url = 'http://192.168.50.104:8000/producers/id/' + producer.producerId.toString();
    }
